...
export function Level() {
  ...
  const isSdnLab = safeLevel.mechanic === 'sdnSimulator' || safeLevel.mechanic === 'virtualizationLab' || Boolean(safeLevel.setup.questionTopic) || Boolean(safeLevel.setup.codeBuilder) || Boolean(safeLevel.setup.codeSection)
