...
export const moduleC: ContentModule = {
  ...
  levels: [
    {
      id: 'C-L01', title: 'Install Your First Flow',
    ...
    {
      id: 'C-L02', title: 'One Switch, Four Roles',
    ...
    {
      id: 'C-L03', title: 'Non-Shortest-Path Flow',
    ...
    {
      id: 'C-L05', title: 'Link Failure Boss',
