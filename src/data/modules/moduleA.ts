...
export const moduleA: ContentModule = {
  ...
  levels: [
    {
      id: 'A-L01', title: 'Draw the Sawtooth',
    ...
    {
      id: 'A-L02', title: 'Slow Start to Avoidance',
    ...
    {
      id: 'A-L06', title: 'Goodput Boss — ECN/DCTCP',
