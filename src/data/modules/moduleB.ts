// Module B — Network Layer: Forwarding, Routing Protocols, Router Design (Deck 2)
...
export const moduleB: ContentModule = {
  id:          'B',
  title:       'Network Layer',
  sourceDeck:  'Deck 2 — Network Layer: Forwarding, Routing Protocols, Router Design (67 slides)',
  ...
  flashcards: [
    {
      ...
      tags:  ['B', 'forwarding', 'routing'],
    },
    {
      id: 'B-02', type: 'term-definition',
      ...
      tags:  ['B', 'CIDR', 'addressing'],
    },
    {
      id: 'B-03', type: 'which-protocol',
      ...
      tags:  ['B', 'OSPF', 'link-state', 'intra-AS'],
    },
    {
      ...
      tags:  ['B', 'RIP', 'distance-vector', 'intra-AS'],
    },
    {
    ...
    },
    {
      ...
      tags:  ['B', 'LPM', 'TCAM', 'forwarding'],
    },
    {
      id: 'B-07', type: 'term-definition',
      ...
      tags:  ['B', 'HOL', 'VOQ', 'router-internals'],
    },
    {
      id: 'B-08', type: 'fill-table',
      ...
      tags:  ['B', 'LPM', 'forwarding'],
    },
    {
      id: 'B-09', type: 'term-definition',
      ...
      tags:  ['B', 'DHCP', 'addressing'],
    },
    {
      id: 'B-10', type: 'compare-two',
      ...
      tags:  ['B', 'control-plane', 'SDN'],
    },
  ],

  levels: [
    {
      id: 'B-L01', title: 'First Address Block',
    ...
    {
      id: 'B-L02', title: 'VLSM — Three Departments',
    ...
    {
      id: 'B-L03', title: 'Wire the Office',
    ...
    {
      id: 'B-L03B', title: 'Ring Resilience',
    ...
    {
      id: 'B-L04', title: 'Dijkstra Step-through',
    ...
    {
      id: 'B-L05', title: 'Count to Infinity',
    ...
    {
      id: 'B-L06', title: 'BGP Policy Boss',
    ...
    {
      id: 'B-L09', title: 'VOQ to the Rescue',
