...
export const CAMPAIGN_ACTS: Act[] = [
  {
    ...
    moduleIds:   ['A'],
    levels:      moduleA.levels.filter((l) => l.mechanic === 'addressSpace'),
    unlockThreshold: 0,
  },
  {
    id: 'act-2', number: 2,
    ...
    moduleIds:   ['A'],
    levels:      moduleA.levels.filter((l) => l.mechanic === 'topologyCanvas'),
    unlockThreshold: 0.3,
  },
  {
    id: 'act-3', number: 3,
    ...
    moduleIds:   ['A'],
    levels:      moduleA.levels.filter((l) => l.mechanic === 'routingGraph' && !l.id.includes('BGP') && l.id < 'A-L06'),
    unlockThreshold: 0.4,
  },
  {
    id: 'act-4', number: 4,
    ...
    moduleIds:   ['A'],
    levels:      moduleA.levels.filter((l) => l.id === 'A-L06'),
    unlockThreshold: 0.5,
  },
  {
    id: 'act-5', number: 5,
    ...
    moduleIds:   ['A'],
    levels:      moduleA.levels.filter((l) => l.mechanic === 'routerInternals'),
    unlockThreshold: 0.5,
  },
  {
    id: 'act-6', number: 6,
